...
const profitParams = {
  ...
  weekly: {
    ...
    totalTrades: "5",
    days: JSON.stringify([
      { day: "M", pnl: 1400, win: true },
      { day: "T", pnl: 800, win: true },
      { day: "W", pnl: 0, win: false },
      { day: "T", pnl: 1600, win: true },
      { day: "F", pnl: -600, win: false },
      { day: "S", pnl: 2000, win: true },
...
const lossParams = {
  ...
  weekly: {
    ...
    days: JSON.stringify([
      ...
      { day: "W", pnl: -800, win: false },
      { day: "T", pnl: 0, win: false },
      { day: "F", pnl: 600, win: true },
