...
const lossParams = {
  ...
  weekly: {
    ...
    days: JSON.stringify([
      { day: "M", pnl: 0, win: false },
      { day: "T", pnl: -2500, win: false },
      { day: "W", pnl: 800, win: true },
      { day: "T", pnl: 600, win: true },
      { day: "F", pnl: -2760, win: false },
      { day: "S", pnl: -1500, win: false },
      { day: "S", pnl: 0, win: false },
    ]),
    bestDay: "Wed +800",
  },
  monthly: {
    ...
    calendar: JSON.stringify({
      1: -6500, 2: -1800, 3: 1500, 6: -3627, 7: 550,
      8: -1539, 9: -1120, 10: 1800, 13: -2500, 14: 800, 15: 600,
      16: -2760, 17: -1500, 20: -1250, 21: 3200, 22: -900, 23: 1400,
      24: -1850, 27: -1800, 28: 1430, 29: 2200, 30: -2160, 31: -900,
    }),
    calendarGrid: JSON.stringify([
      null, null, null, 1, 2, 3, 4,
